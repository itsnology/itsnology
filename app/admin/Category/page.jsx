...
const PageCat = () => {
  ...
  const deletePrompt = async (category) => {
    try {
      ...
      if (confirm.isConfirmed) {
        const response = await fetch(`/api/category/editCat/${category._id}`, {
          method: "DELETE",
        });
  ...
  return (
    <div className="flex md:flex-row ">
      <SideBar />
      <div className="flex w-full mx-auto mt-28 lg:ms-8 flex-col">
        <div className="flex-col flex ">
          ...
          {loggedIn ? (
            <div>
              ...
              >
                ...
                <div className="flex mt-4">
                  ...
                  >
                    {formData.editingIndex !== undefined ? "تعديل" : "إضافة"}
                  </button>
            ...
            <Adminlogin login={submitLogin} className="w-full" />
          )}
        </div>
      </div>
    </div>
