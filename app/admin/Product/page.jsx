    ...
    <div className="flex md:flex-row">
      ...
      <div className=" flex flex-col mr-8">
        ...
        <div className="justify-center flex mt-20">
          {" "}
          <p className="text-6xl font-semibold text-sky-950 ">
            {" "}
            إدارة المنتجات
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mx-auto mt-12  flex-row  justify-center mb-4 ">
          <div className="mx-4">
